...
- Each of the 30 checkpoints plays asset `10066936758` once at volume 0.045. Playback speed rises linearly from 0.72 to 1.42 across the sequence, so the same short tick moves from low/thick to high/bright. These cues are separate from entry/pop/ready/exit audio and use a short 0.8-second cleanup lifetime.
