...
- Every checkpoint plays the short `RBLX UI Hover 02` tick (`10066936758`) at volume 0.045. Playback speed interpolates linearly from 0.72 on checkpoint 1 to 1.42 on checkpoint 30, creating a continuous low/thick-to-high/bright rise. Checkpoint sounds use a dedicated 0.8-second cleanup window and may not replace or duplicate the final ready pop.
