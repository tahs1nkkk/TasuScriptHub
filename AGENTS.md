...
- `UI.LegacyUIEnabled` remains `false` during the rework. No legacy window, bar, modal, toast, search surface, preview, stats panel, or unload screen may become visible.
